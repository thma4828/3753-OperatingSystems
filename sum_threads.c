...
int main(int argc, char **argv){
    ...
    results_txt = fopen("/home/user/3753/results.txt", "a");
    serviced_txt = fopen("/home/user/3753/serviced.txt", "a");
...
void *producer(void *param){ //note that each thread should stay open to execute further files in real prog
	...
	if(serviced_txt){
		...
		fprintf(serviced_txt, "Thread %lu serviced %d files", pthread_self(), fc);
